...
public interface MediaPlaybackManager {
    ...
    /** The speed at which the current media is being played. 1024 means 1X, 512 means 0.5X and 2048 means 2X */
    ...
    /** Play media. If content is currently in a FastForward or Rewind state. Play SHALL return media to normal playback speed. */
    int REQUEST_PLAY = 0;
    ...
    /** Change the playback position in the media to the given position by the given number of milliseconds */
    int REQUEST_SEEK = 10;
